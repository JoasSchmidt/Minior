...
import { Text, View, Alert, StyleSheet, SafeAreaView, Platform, StatusBar, Image, ImageBackground, Dimensions } from 'react-native';
...
constructor(){
 ...
 componentDidMount() {
    ...
    getMeteors = () => {
        axios
            .get("https://api.nasa.gov/neo/rest/v1/feed?start_date=2015-09-07&end_date=2015-09-08&api_key=Eyr112htgAJ993yHJcXOLbGbSEEN6hfuBcruQL8d")
            .then(response => {
